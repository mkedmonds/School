<?php
    ...
    if ($_SESSION["signedIn"] == "confirm") {
        ...
        $sql = "SELECT event_id, event_name, event_presenter, DATE_FORMAT(event_date, '%c/%e/%Y') as event_formatted_date, TIME_FORMAT(event_time, '%h:%i:%p') as event_formatted_time, event_description, event_location FROM eventsite_formal ORDER BY event_date DESC ";
