  ...
  if (isset($_POST["submit"])) {
      ...
      if ($validForm) {
          ...
          try {
              ...
              $sql = "UPDATE eventsite_formal SET event_name='$eventName', event_description='$eventDescription', event_presenter='$eventPresenter', event_location='$eventLocation', event_date='$eventDate', event_time='$eventTime' WHERE event_id='$recId'
    ...
    require 'connection.php';
		...
		$sql = "SELECT event_name, event_description, event_presenter,event_location, event_date, event_time 
				FROM eventsite_formal WHERE event_id = :eventID
			";
