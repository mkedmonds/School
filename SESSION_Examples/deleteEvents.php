  ...
  if (isset($_POST["submit"])) {
      ...
      if ($validForm) {
          ...
          try {
              ...
              $sql = "DELETE FROM eventsite_formal WHERE event_name='$eventName'
    ...
    require 'connection.php';
		...
		$sql = "SELECT event_name, event_description, event_presenter,event_location, event_date, event_time 
				FROM eventsite_formal WHERE event_id = $recId
			";
...
<body>
    ...
    <h4>Please make your corrections and press Delete when you are done.</h4>
...
<form action="deleteEvents.php?recId=<?php echo $recId; ?>" method="post">
