...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inVisit = $_POST["vistDmacc"];			//get the value of 'YES' or 'NO'
	$inColor = $_POST["color"];  			//get the value of the color
	$inMusic = $_POST["music"]; 				//get the value of music
	
	$inHoneyPot = $_POST["hiddenField"]; 		//HIDDEN HONEY POT FIELD

	//HoneyPot Testing: if the invisible field is filled then a bot is filling it out
	if(trim($inHoneyPot) != ""){
		alert("SPAMMER!");
	}
...
<p>Visited Dmacc: <?php echo $inVisit; ?></p>
<p>Favorite Color: <?php echo $inColor; ?></p>
<p>Music: <?php echo $inMusic; ?></p>

<p><a href="exampleForm.html">Go Back To Form</a></p>
</body>
</html>
