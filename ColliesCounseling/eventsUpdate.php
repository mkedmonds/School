      ...
      if ($validForm) {
          ...
          try {
             ...
             $stmt->bindParam(":eName", $eventName);
              ...
              $message = "The event has been updated. Thank you.";
              ...
              header('Location: eventsUpdate.php');	//sends control to a User friendly page	
          }
...
<form action="eventsUpdate.php?recId=<?php echo $recId; ?>" method="post">
  ...
  <p>
      <input type="submit" class="submitResetBtn button" name="submit" value="Update">
